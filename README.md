...
[![Version](https://img.shields.io/badge/Version-4.9-brightgreen.svg)]()
...
* ### 现代化且稳定的UI/UX
  ...
  * **精致的固定布局**: 采用用户最终确认的`685x530`固定窗口大小，界面紧凑、专业。
  * **可调节的左右分栏**: 界面采用左右布局，左侧为操作区，右侧为日志区。中间的分割线可以在`320px - 520px`（*此范围也会随DPI自动缩放*）的范围内自由拖拽，兼顾了布局的稳定性与操作的灵活性。
